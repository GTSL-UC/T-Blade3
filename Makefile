...
OBJS_SRC = $(SRC_DIR)/globvar.o $(SRC_DIR)/file_operations.o $(SRC_DIR)/errors.o $(SRC_DIR)/spline.o $(SRC_DIR)/readinput.o $(SRC_DIR)/funcNsubs.o \
		   $(SRC_DIR)/3dbgb.o $(SRC_DIR)/bladegen.o $(SRC_DIR)/bladestack.o $(SRC_DIR)/bspline3.o $(SRC_DIR)/lesting.o $(SRC_DIR)/cubicspline.o $(SRC_DIR)/lespline.o \
