...
print ('*                  in a PDF (thickness_data.pdf)                         *')
print ('*                                                                        *')
...
# TODO: Add plotting for quartic spline thickness distribution
...
with PdfPages('thickness_data.pdf') as pdf:
    ...
    art.append(lgd)
    pdf.savefig(additional_artists = art, bbox_inches = 'tight')
