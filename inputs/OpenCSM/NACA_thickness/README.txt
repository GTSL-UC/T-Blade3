...
A blade which uses a NACA airfoil with thickness applied. This blade is in row 2 which contains 16 blades.
...
2) To run with ESP:
   /path/to/executable/.serveCSM /path/to/file/tblade_NACA_thickness.csm
