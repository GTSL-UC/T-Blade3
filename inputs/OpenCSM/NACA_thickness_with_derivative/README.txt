...
A blade which uses a NACA airfoil with thickness applied. This is blade row 2 which has 16 blades.
...
2) To run with ESP:
   /path/to/executable/.serveCSM /path/to/file/tblade_NACA_thickness_derivative.csm
