...
This is an inlet guide vane (IGV) for the 7-28-8 case. This case is in row 1, 
which contains 20 blades. This geometry contains one IGV blade and no hubwedge. 
