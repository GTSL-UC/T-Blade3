...
Turbine blade geometry. This is blade row 2 and contains 71 blades. The geometry includes one blade.
...
2) To run with ESP:
   /path/to/executable/.serveCSM /path/to/file/turbine_geometry.csm
