...
Outlet guide vane (OGV) from case 7-28-5. This is blade row 3 and contains 33 blades. The geometry includes one blade.

This case is made to be run in mises. See mises_instructions.pdf for instructions on running.
...
1) To run case with T-Blade3:
   /path/to/executable/.tblade /path/to/file/3dbgbinput.3.dat
2) To run with ESP:
   /path/to/executable/.serveCSM /path/to/file/LE75.csm
