...
Wind Turbine blade geometry. This wind turbine contains 80 blades. The geometry includes one blade.
...
2) To run with ESP:
   /path/to/executable/.serveCSM /path/to/file/wind_turbine_geometry.csm
