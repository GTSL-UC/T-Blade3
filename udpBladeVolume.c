 ...
 ************************************************************************
 *                                                                      *
 * udpBladeVolume- udp to create volume around turbomachinery blade     *
 *                                                                      *
...
#define SPAN_CHORD(    IUDP,I) ((double *) (udps[IUDP].arg[ 4].val))[I]
#define SPAN_THK_C(    IUDP,I) ((double *) (udps[IUDP].arg[ 5].val))[I]
#define SPAN_IN_BETA(  IUDP,I) ((double *) (udps[IUDP].arg[ 6].val))[I]
#define SPAN_OUT_BETA( IUDP,I) ((double *) (udps[IUDP].arg[ 7].val))[I]
#define U2(            IUDP,I) ((double *) (udps[IUDP].arg[ 8].val))[I]
#define U3(            IUDP,I) ((double *) (udps[IUDP].arg[ 9].val))[I]
#define U4(            IUDP,I) ((double *) (udps[IUDP].arg[10].val))[I]
#define U5(            IUDP,I) ((double *) (udps[IUDP].arg[11].val))[I]
#define U6(            IUDP,I) ((double *) (udps[IUDP].arg[12].val))[I]
#define CUR1(          IUDP,I) ((double *) (udps[IUDP].arg[13].val))[I]
#define CUR2(          IUDP,I) ((double *) (udps[IUDP].arg[14].val))[I]
#define CUR3(          IUDP,I) ((double *) (udps[IUDP].arg[15].val))[I]
#define CUR4(          IUDP,I) ((double *) (udps[IUDP].arg[16].val))[I]
#define CUR5(          IUDP,I) ((double *) (udps[IUDP].arg[17].val))[I]
#define CUR6(          IUDP,I) ((double *) (udps[IUDP].arg[18].val))[I]
#define CUR7(          IUDP,I) ((double *) (udps[IUDP].arg[19].val))[I]
#define SPAN_CURV_CTRL(IUDP,I) ((double *) (udps[IUDP].arg[20].val))[I]
#define SPAN_DEL_M(    IUDP,I) ((double *) (udps[IUDP].arg[21].val))[I]
#define SPAN_DEL_THETA(IUDP,I) ((double *) (udps[IUDP].arg[22].val))[I]
#define SPAN_THK_CTRL( IUDP,I) ((double *) (udps[IUDP].arg[23].val))[I]
#define EXACT_U1(      IUDP,I) ((double *) (udps[IUDP].arg[24].val))[I]
#define EXACT_U2(      IUDP,I) ((double *) (udps[IUDP].arg[25].val))[I]
#define EXACT_U3(      IUDP,I) ((double *) (udps[IUDP].arg[26].val))[I]
#define EXACT_U4(      IUDP,I) ((double *) (udps[IUDP].arg[27].val))[I]
#define EXACT_U5(      IUDP,I) ((double *) (udps[IUDP].arg[28].val))[I]
#define EXACT_U6(      IUDP,I) ((double *) (udps[IUDP].arg[29].val))[I]
#define EXACT_U7(      IUDP,I) ((double *) (udps[IUDP].arg[30].val))[I]
#define EXACT_THK1(    IUDP,I) ((double *) (udps[IUDP].arg[31].val))[I]
#define EXACT_THK2(    IUDP,I) ((double *) (udps[IUDP].arg[32].val))[I]
#define EXACT_THK3(    IUDP,I) ((double *) (udps[IUDP].arg[33].val))[I]
#define EXACT_THK4(    IUDP,I) ((double *) (udps[IUDP].arg[34].val))[I]
#define EXACT_THK5(    IUDP,I) ((double *) (udps[IUDP].arg[35].val))[I]
#define EXACT_THK6(    IUDP,I) ((double *) (udps[IUDP].arg[36].val))[I]
#define EXACT_THK7(    IUDP,I) ((double *) (udps[IUDP].arg[37].val))[I]
...
static char*  argNames[NUMUDPARGS] = {"ncp",            "filename",     "auxname",          "average",
                                      "span_chord",     "span_thk_c",   "span_in_beta",     "span_out_beta",
                                      "u2",             "u3",           "u4",               "u5",
                                      "u6",             "cur1",         "cur2",             "cur3",         
                                      "cur4",           "cur5",         "cur6",             "cur7",          
                                      "span_curv_ctrl", "span_del_m",   "span_del_theta",   "span_thk_ctrl",
                                      "exact_u1",       "exact_u2",     "exact_u3",         "exact_u4",
...
#define NPNT 1000
    ...
    double  xyz[3*NPNT], /*rms, xyzNode[18],*/data[6],/*data2[12],*/node0[3],node1[3],node2[3],node3[3],/*node4[3],node5[3],*/xyz2[3*NPNT],xyz3[3*NPNT],angle,bladespace,nblades;
...
data[1] = node3[1];
data[2] = node3[2];
data[3] = node0[0] - node3[0];
data[4] = node0[1] - node3[1];
data[5] = node0[2] - node3[2];
...
void
override_span_chord_(int    *nspn, double span_chord[])
{
    int    ispn, narg=4;
...
void
override_span_thk_c_(int    *nspn, double span_thk_c[])
{
    int    ispn, narg=5;
...
void
override_span_in_beta_(int    *nspn, double span_in_beta[])
{
    int    ispn, narg=6;
...
void
override_span_out_beta_(int    *nspn, double span_out_beta[])
{
    int    ispn, narg=7;
...
void 
override_u2_(int    *nspn, double u2[])
{
    int    ispn, narg=8;
...
void 
override_u3_(int    *nspn, double u3[])
{
    int    ispn, narg=9;
...
void 
override_u4_(int    *nspn, double u4[])
{
    int    ispn, narg=10;
...
void 
override_u5_(int    *nspn, double u5[])
{
    int    ispn, narg=11;
...
void 
override_u6_(int    *nspn, double u6[])
{
    int    ispn, narg=12;
...
void
override_cur1_(int    *nspn, double cur1[])
{
    int    ispn, narg=13;
...
void
override_cur2_(int    *nspn, double cur2[])
{
    int    ispn, narg=14;
...
void
override_cur3_(int    *nspn, double cur3[])
{
    int    ispn, narg=15;
...
void
override_cur4_(int    *nspn, double cur4[])
{
    int    ispn, narg=16;
...
void
override_cur5_(int    *nspn, double cur5[])
{
    int    ispn, narg=17;
...
void
override_cur6_(int    *nspn, double cur6[])
{
    int    ispn, narg=18;
...
void
override_cur7_(int    *nspn, double cur7[])
{
    int    ispn, narg=19;
...
void
override_span_curv_ctrl_(int   *nspn, double span_curv_ctrl[])
{
    int    ispn, narg=20;
...
void 
override_span_del_m_(int   *nspn, double span_del_m[])
{
    int   ispn, narg=21;
...
void 
override_span_del_theta_(int   *nspn, double span_del_theta[])
{
    int   ispn, narg=22;
